...
function WarehousePanel.new(parent, onPut, onTake)
  ...
  spaceLabel.TextColor3 = Color3.fromRGB(200, 180, 80)
  ...
  local function parseAmount(state, isPut)
    ...
    if raw == "A" then
      if isPut then return state and state.shipCargo[selectedGood] or 0
      else return state and state.warehouseCargo[selectedGood] or 0 end
    end
  ...
  putBtn.TextColor3 = Color3.fromRGB(140, 200, 80)   -- Green (was Blue)
  ...
  putBtn.Activated:Connect(function()
    ...
    if qty > 0 then onPut(selectedGood, qty); amountBox.Text = "" end
  end)
  ...
  takeBtn.TextColor3 = Color3.fromRGB(140, 200, 80)
  ...
  takeBtn.Activated:Connect(function()
    ...
    if qty > 0 then onTake(selectedGood, qty); amountBox.Text = "" end
  end)
