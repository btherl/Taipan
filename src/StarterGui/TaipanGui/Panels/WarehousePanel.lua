...
function WarehousePanel.new(parent, onPut, onTake)
  ...
  spaceLabel.TextColor3 = Color3.fromRGB(120, 120, 180)
  ...
  for i = 1, 4 do
    ...
    btn.Name = "GoodBtn" .. i
    btn.Size = UDim2.new(0.22, -4, 0, 24)
  ...
  amountBox.Position = UDim2.new(0, 5, 0, 58)
  ...
  putBtn.Name = "PutBtn"
  putBtn.Size = UDim2.new(0.22, -4, 0, 32)
  putBtn.Position = UDim2.new(0, 5, 0, 90)
  putBtn.BackgroundColor3 = Color3.fromRGB(20, 20, 60)
  putBtn.BorderColor3 = Color3.fromRGB(40, 40, 120)
  putBtn.TextColor3 = Color3.fromRGB(100, 100, 255)
  ...
  takeBtn.Size = UDim2.new(0.22, -4, 0, 32)
  takeBtn.Position = UDim2.new(0.25, 0, 0, 90)
  takeBtn.BackgroundColor3 = Color3.fromRGB(60, 20, 20)
  takeBtn.BorderColor3 = Color3.fromRGB(120, 40, 40)
  takeBtn.TextColor3 = Color3.fromRGB(255, 100, 100)
