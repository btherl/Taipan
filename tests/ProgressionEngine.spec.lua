...
return function()
  ...
  describe("repairAmount", function()
    it("returns INT(W/BR + 0.5)", function()
      expect(PE.repairAmount(100, 150)).to.equal(2)
      expect(PE.repairAmount(100, 249)).to.equal(2)
      expect(PE.repairAmount(100, 250)).to.equal(3)
  ...
  describe("repairAllCost", function()
    it("returns BR * ceil(damage) + 1", function()
      ...
      expect(PE.repairAllCost(100, 2.1)).to.equal(301)
  ...
  describe("applyRepair", function()
    it("deducts cash and reduces damage", function()
      ...
      local repaired = PE.applyRepair(s, 100, 300)
    ...
    it("caps repaired damage at actual damage", function()
      ...
      local repaired = PE.applyRepair(s, 100, 5000)
